    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0">
          <img
            src="https://www.lancome-usa.com/dw/image/v2/AANG_PRD/on/demandware.static/-/Sites-lancome-us-Library/default/dw6ee2fc5d/images/beauty%20mag/2021/10%20October/LU11554_SignatureScent_1280x639.jpg?sw=2000&q=70"
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-white/30"></div>
      ...
      <div className="absolute inset-0 z-10">
        ...
        <Sparkles
          className="absolute top-32 right-32 h-6 w-6 text-rose-300 animate-pulse opacity-60"
          style={{ animationDelay: "1s" }}
        />
        <Sparkles
          className="absolute bottom-40 left-40 h-7 w-7 text-amber-400 animate-pulse opacity-70"
          style={{ animationDelay: "2s" }}
        />
        <Sparkles
          className="absolute bottom-32 right-20 h-5 w-5 text-rose-400 animate-pulse opacity-50"
          style={{ animationDelay: "0.5s" }}
        />
        <Sparkles
          className="absolute top-1/2 left-10 h-4 w-4 text-amber-200 animate-pulse opacity-40"
          style={{ animationDelay: "1.5s" }}
        />
        <Sparkles
          className="absolute top-1/3 right-10 h-6 w-6 text-rose-200 animate-pulse opacity-60"
          style={{ animationDelay: "2.5s" }}
        />

        {/* Floating Geometric Shapes */}
        <div
          className="absolute top-1/4 left-1/4 w-16 h-16 border border-white/20 rounded-full animate-float opacity-30"
          style={{ animationDelay: "3s" }}
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-12 h-12 border border-amber-300/30 rotate-45 animate-float opacity-40"
      ...
      <div className="relative z-20 text-center max-w-6xl mx-auto px-4">
        <div className="animate-fade-in-up">
          ...
          <h1 className="text-7xl md:text-9xl font-playfair font-bold text-white mb-8 leading-tight tracking-tight">
            Discover Your
            <span className="block bg-gradient-to-r from-amber-300 via-rose-300 to-rose-300 bg-clip-text text-transparent animate-gradient-x">
              Signature Scent
            </span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-white/85 max-w-3xl mx-auto leading-relaxed font-light mb-6">
            Indulge in our curated collection of luxury perfumes, where each
            fragrance tells a unique story of elegance and sophistication
          </p>
      ...
      <div
        className="absolute bottom-20 right-20 w-96 h-96 bg-amber-400/10 rounded-full blur-3xl animate-pulse opacity-50"
        style={{ animationDelay: "2s" }}
      ></div>
    </section>
  );
