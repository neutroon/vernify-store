      ...
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-playfair font-bold text-amber-900 mb-6">
            Shop <span className="bg-gradient-to-r from-rose-600 to-amber-600 bg-clip-text text-transparent">All Fragrances</span>
          </h1>
          <p className="text-xl text-amber-700 max-w-2xl mx-auto leading-relaxed font-light">
            Browse our complete collection of premium perfumes and find your perfect scent
          </p>
